...
public class FractalExplorer {
    ...
    private class FractalWorker extends SwingWorker<Object,Object>{   //подкласс SwingWorker
        private int y;
        ...
        @Override
        protected Object doInBackground() throws Exception {    //метод, который фактически выполняет все фоновые операции
        ...
        @Override
        protected void done() { //метод, который вызывается, когда фоновая задача завершена
